...
<Aside type="caution" title="OpenClaw gets extra scrutiny">
When OpenClaw is detected, Fleet Auditor layers on security checks: an outdated gateway, malicious ClawHub skills, and disabled rate limiting. These are scored high severity because a compromised instance burns tokens until you notice. See [Waste detectors](/features/waste-detectors/).
</Aside>
