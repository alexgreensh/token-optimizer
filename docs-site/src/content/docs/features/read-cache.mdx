...
`TOKEN_OPTIMIZER_READ_CACHE`, `TOKEN_OPTIMIZER_READ_CACHE_DELTA`, and `TOKEN_OPTIMIZER_STRUCTURE_MAP`. Config keys `v5_delta_mode`, `v5_structure_map_beta`, and `read_cache_enabled`. All defined in the [configuration reference](/reference/configuration/).
