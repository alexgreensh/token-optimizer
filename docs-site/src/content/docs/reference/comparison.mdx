...
|---|---|---|---|
| **Bash / command output** (git, test runners, lint, build, listings, logs) | 🟢 110+ commands across 22 pattern families, credential-safe; 564 → 115 tokens on a pytest run | 🟢 6 algorithms incl. model-based | 🟢 100+ command filters |
...
|---|---|---|---|---|---|
| Tool output compression | 🟢 110+ commands across 22 pattern families, credential-safe, toggleable | 🟢 6 algorithms incl. model-based | 🟢 100+ command filters | 🟢 Sandbox + summary | 🔴 |
