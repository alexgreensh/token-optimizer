...
export type Audit = { toolCalls: number; repeatedToolCalls: number; largeToolResults: number; toolResultTokensEstimate: number; modelCostNative: number; modelCostEstimated: number; savingsVerified: number; advice: string[] };
